      ...
      <div className=" w-full flex justify-between items-center">
        <div className=" flex ">
          ...
          <div className="mx-3 mt-3">
            ...
            <h2 className="text-lg text-gray-500 dark:text-slate-400">{course} Intern</h2>
          </div>
        </div>
        <button className="flex p-1.5 border border-stone-200 rounded-lg">
          <Eye className="size-5" />
          <p className="ml-1 text-sm font-bold text-gray-700 dark:text-slate-300">View Details</p>
        </button>
      </div>
      <div className="grid grid-cols-12 mt-6">
        <div className="flex col-span-12 justify-evenly items-start">
          <div className=" w-full">
            <h1 className="text-sm font-medium text-gray-500 dark:text-slate-400">University</h1>
            <h2 className="font-bold ">{institution}</h2>
          </div>
          <div className=" w-full">
            <h1 className="text-sm font-medium text-gray-500 dark:text-slate-400">Start Date</h1>
            <h2 className="font-bold ">{start_date}</h2>
          </div>
          <div className=" w-full">
            <h1 className="text-sm font-medium text-gray-500 dark:text-slate-400">Performance</h1>
        ...
        <div className="flex col-span-12 justify-evenly items-start mt-6">
          <div className="flex w-full items-center">
            ...
            <p className="text-gray-500 text-sm font-medium ml-1.5 dark:text-slate-400">{email}</p>
          </div>
          <div className="flex w-full items-center">
        ...
        <div className="flex col-span-12 justify-between mt-6 ">
          <p className="text-sm text-gray-500 dark:text-slate-400">Internship Progress</p>
          <p className="text-sm text-gray-700 font-medium dark:text-slate-300">Week {week} of 12</p>
        </div>
        ...
        <div className="flex col-span-12 justify-between ">
          <p className="text-xs text-gray-500 dark:text-slate-400">{logs} logs approved</p>
          <p className="text-xs text-gray-700 font-medium dark:text-slate-300">{12 - week} weeks remaining</p>
        </div>
      </div>
    </div>
  );
