...
export const interns = [
  {
    ...
    log: {
      activities:
        "This week I focused on refactoring the authentication module using React Context API. I implemented token-based authentication with JWT and integrated it with the backend API. Additionally, I worked on creating protected routes and implementing role-based access control. I also participated in daily stand-up meetings and code reviews with the team.",
      learnings:
        "I learned about secure authentication practices, including password hashing, token management, and session handling. I gained deeper understanding of React Context API and how to structure authentication flows in a production environment. The code review sessions taught me best practices for writing clean, maintainable code.",
      challenges:
        "Faced challenges with slow query performance due to large datasets, but resolved it by implementing proper indexing and optimizing the query logic. Also had to troubleshoot some issues with data consistency, which I addressed by implementing transactions and improving error handling in the database layer.",
    },
  },
  {
    ...
    log: {
      ...
      learnings:
        "I learned about database optimization strategies, including indexing and query restructuring. The workshop provided insights into advanced SQL features and performance tuning. I also improved my collaboration skills by working closely with the frontend team to align our efforts.",
      challenges:
        "Faced challenges with slow query performance due to large datasets, but resolved it by implementing proper indexing and optimizing the query logic. Also had to troubleshoot some issues with data consistency, which I addressed by implementing transactions and improving error handling in the database layer.",
    },
  },
...
const PendingLogSection = () => {
  ...
  return (
    <div className="grid col-span-12 mt-6 gap-3 grid-cols-12">
      <Pending_logs
        interns={interns}
        selectedLog={pendingLogs}
        onSelectLog={setPendingLogs}
      />
