...
const MetricCard = ({ title, value, iconType }) => (
  <div className="flex cursor-pointer flex-col gap-4 rounded-[12px] border border-border bg-white p-4 transition-all duration-300 hover:scale-105 sm:gap-5 sm:p-6">
    <div className="mb-1 text-sm font-medium tracking-[0.18em] text-text-secondary opacity-60 sm:text-base">
      {title
        .split(" ")
        .map(
    ...
    <div className="flex w-full items-center justify-between gap-4">
      <div className="text-2xl font-black tracking-tight text-lime-600 sm:text-3xl">
        {value}
      </div>
