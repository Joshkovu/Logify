...
urlpatterns = [
    ...
    path("approve_weekly_log/<str:log_id>/", views.ApproveWeeklyLogAPIView.as_view(), name="approve_weekly_log"),  # type: ignore
    path("reject_weekly_log/<str:log_id>/", views.RejectWeeklyLogAPIView.as_view(), name="reject_weekly_log"),  # type: ignore
]
